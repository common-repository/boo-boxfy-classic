...
if ($.browser.mozilla && parseInt($.browser.version) < 3 && (/mac/i.test(navigator.platform))) {
	o.addClass('jqmOverlayMacFix');
} else {
	o.addClass('jqmOverlay');
}
h.o=(o)?o.prependTo('body'):false;
